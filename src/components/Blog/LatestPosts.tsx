        ...
        <div className="flex flex-col gap-6">
          ...
          {blogs.slice(0, 3).map((blog, key) => (
            <div className="flex items-center gap-4" key={key}>
              ...
              >
                <Image
                  src={getImageUrl(blog.mainImage || blog.img, "/images/blog/blog-01.jpg")}
                  alt="blog"
              ...
              <div>
                ...
                <span className="flex items-center gap-3">
                  ...
                  >
                    {blog.date || (blog.publishedAt ? new Date(blog.publishedAt).toLocaleDateString() : "Unknown date")}
                  </a>
                  ...
                  <a
                    ...
                    className="text-custom-xs ease-out duration-200 hover:text-blue"
                  >
                    {blog.views ? `${Math.floor(blog.views / 1000)}k` : `${Math.floor(Math.random() * 500) + 50}k`} Views
                  </a>
                </span>
              </div>
            </div>
