              ...
              <div className="flex xl:flex-col">
                ...
                <div className="p-4 sm:p-7.5 xl:p-9">
                  <div className="flex flex-wrap xl:flex-nowrap xl:flex-col gap-4">
                    ...
                    <button
                      onClick={() => signOut()}
                      className="flex items-center rounded-md gap-2.5 py-3 px-4.5 ease-out duration-200 hover:bg-red hover:text-white text-red bg-gray-1"
                    >
                      <svg
                        className="fill-current"
                        width="22"
          ...
          <!--== user dashboard content start ==--> */}
            ...
            >
              <p className="text-dark">
                Hello {session?.user?.name || session?.user?.email?.split('@')[0] || 'User'} (not you?{' '}
                <button
                  onClick={() => signOut()}
