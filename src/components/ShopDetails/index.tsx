...
const ShopDetails = ({ product: productProp }: ShopDetailsProps) => {
  ...
  // Use the product prop if provided, otherwise fall back to Redux/localStorage
  const alreadyExist = typeof window !== 'undefined' ? localStorage.getItem("productDetails") : null;
  const productFromStorage = useAppSelector(
    (state) => state.productDetailsReducer.value
  );

  const product = productProp || (alreadyExist ? JSON.parse(alreadyExist) : productFromStorage);

  // Create tabs dynamically based on product data
  const tabs = [
    {
      id: "tabOne",
      title: "Description",
    },
    // Only show Additional Information tab if product has additional information
                    ...
                    <div className="flex flex-col gap-4.5 border-y border-gray-3 mt-7.5 mb-9 py-9">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            className="w-8 h-8 flex items-center justify-center border border-gray-3 rounded"
                          >
                            -
                        </button>
                  ...
                  <div className="max-w-[447px] w-full">
                    ...
                    <div className="space-y-4">
                      ...
                      {product?.tags && product.tags.length > 0 && (
                        <div>
                          <span className="font-medium text-dark">Tags: </span>
